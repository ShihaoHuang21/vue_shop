  ...
  <div class="page">
    ...
    <el-dialog title="提示" :visible.sync="editRoleDialogVisible" width="50%">
      <span>
        ...
        >
          <el-form-item label="角色ID" prop="roleId">
            <el-input v-model="editRoleFrom.roleId" :disabled="true"></el-input>
          </el-form-item>
          <el-form-item label="角色名称" prop="roleName">
      ...
      <span slot="footer" class="dialog-footer">
        ...
        <el-button type="primary" @click="editRoleDialogVisible = false"
          >确 定</el-button
        >
      </span>
    </el-dialog>
...
export default {
  ...
  methods: {
    ...
    //根据id显示修改用户
    async showRoleUserInfo(id) {
      // console.log(id);
      const { data: res } = await this.$http.get('roles/' + id)
      if (res.meta.status !== 200) {
        return this.$message.error('显示编辑用户失败!')
      }
      // this.$message.success('显示编辑用户成功!')
